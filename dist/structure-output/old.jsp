        ...
        <div class="panel-body">
            <table>
                <tr>
                    ...
                    <td>
                        <select class="w140 mt8" id="belongCenter" name="belongCenter" onChange="changeBelongCenter()">
                    ...
                    <td>
                        <select class="w140 mt8" id="belongUnit" name="belongUnit">
                            <option value="">-请选择-</option>
                        </select>
                    </td>
                    <td><span class="w110 name">仪器状态</span></td>
                    <td>
                        <select class="w140 mt8" id="apparatusState" name="apparatusState">
                            <option value="">-请选择-</option>
                ...
                <tr>
                    <td><span class="w110 name">共享状态</span></td>
                    <td>
                        <select class="w140 mt8" id="shareState" name="shareState">
                            <option value="-1">-请选择-</option>
                            <ec:options items="shareStateMap" defaultKey="1"></ec:options>
                        </select>
                    </td>
                    <%-- <td><span class="w110 name">刷卡安装</span></td>
                    <td>
                        <select class="w140 mt8" id="isSwingCard" name="isSwingCard">
                            <option value="">-请选择-</option>
...
<div class="z-page-search-fold"><input type="button" class="btn_style fr" value="查询" onclick="doQuery();" /><input type="reset" class="btn_style fr" value="重置" onclick="doReset()"/>
                        </div>
        </div>
    </div>
</form>
    ...
    <div class="panel-body padding-0" id="userInfo">
        <table style="background: #eef0f3;width: 100%;height: 30px;margin-top: 10px">
            <tr>
                ...
                <td width="25%" align="center" style="font-size: 13px">仪器数量：<input class="w70" style="border:0px;background: #eef0f3;text-align: center" type="text" id="totalApp" name="totalApp" disabled="disabled" value="${totalApp}" />台套</td>
                <td width="25%" align="center" style="font-size: 13px">总价值：<input class="w70" style="border:0px;background: #eef0f3;text-align: center" type="text" id="totalMoney" name="totalMoney" disabled="disabled" value="${totalMoney}"/>万元</td>
                <td width="25%" align="center" style="font-size: 13px">仪器操作人数：<input class="w70" style="border:0px;background: #eef0f3;text-align: center" type="text" id="totalUsers" name="totalUsers" disabled="disabled" value="${totalUsers}"/>人</td>
            </tr>
        </table>
    </div>
</div>
