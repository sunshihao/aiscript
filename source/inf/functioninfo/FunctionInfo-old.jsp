...
<div class="wrapper">
	<form method="post" action="functionInfoAction.do?method=doInit" id="functionInfoForm" name="functionInfoForm">
		<div class="panel panel-default searchTool fl">
			<div class="panel-body">
				<table>
					...
					<tr>
			            <td><span class="w110 name">样品分类</span></td>
						<td>
					...
					<tr>
						<td colspan="6" class="fr">
							...
							<input type="button" class="btn_style fr" value="查询" onclick="doQueryInfo()" />
						</td>
					</tr>
				</table>
			</div>
