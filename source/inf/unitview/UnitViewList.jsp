...
<div class="z-page-home">
    ...
    <div class="panel panel-default fl">
            ...
            <ec:table items="recordList" var="record" retrieveRowsCallback="limit"
                ...
                <ec:row recordKey="${record.belongUnit}">
                    ...
                    <c:if test="${record.belongCenter!='0' and !empty record.belongCenter}">
                        <ec:column width="14%" property="belongCenter" title="所属区域中心"
                                   mappingItem="belongCenterMap" ellipsis="true"/>
                    </c:if>
        ...
        <div class="z-page-search-form" id="userInfo">
            <table style="background: #eef0f3;width: 100%;height: 30px;margin-top: 10px">
                <tr>
                    ...
                    <td width="25%" align="center" style="font-size: 13px">仪器数量：<input class="w70"
                                                                                           style="border:0px;background: #eef0f3;text-align: center"
                                                                                           type="text" id="totalApp"
                                                                                           name="totalApp"
                                                                                           disabled="disabled"
                                                                                           value="${totalApp}"/>台套
                    </td>
                    <td width="25%" align="center" style="font-size: 13px">总价值：<input class="w70"
                                                                                         style="border:0px;background: #eef0f3;text-align: center"
                                                                                         type="text" id="totalMoney"
                                                                                         name="totalMoney"
                                                                                         disabled="disabled"
                                                                                         value="${totalMoney}"/>万元
                    </td>
                    <td width="25%" align="center" style="font-size: 13px">仪器操作人数：<input class="w70"
                                                                                               style="border:0px;background: #eef0f3;text-align: center"
                                                                                               type="text"
                                                                                               id="totalUsers"
                                                                                               name="totalUsers"
