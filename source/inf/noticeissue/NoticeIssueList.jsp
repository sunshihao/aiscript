...
<div class="z-page-home">
    <div class="z-page-title">通知发布</div>
    <form class="z-page-search" method="post" action="/noticeIssueAction.do?method=doQuery" id="noticeIssueForm">
                ...
                <table class="z-page-search-componets">
                    <tr>
                        <td>
                            ...
                            <select class="" id="noticeRange" name="noticeRange">
                        ...
                        <td>
                            ...
                            <input type="text" name="createStartDate" id="createStartDate" class="w140 Wdate"
                                   onclick="WdatePicker({dateFmt:'yyyy-MM-dd',errDealMode:0});">
                        </td>
                        <td>
                            <span class="name">发布日期止:</span>
                            <input type="text" name="createEndDate" id="createEndDate" class="w140 Wdate"
                                   onclick="WdatePicker({dateFmt:'yyyy-MM-dd',errDealMode:0});">
                        </td>
                    </tr>
                </table>
    ...
    <div class="z-page-action z-btn-define">
        <input type="button" class="btn_style z-btn-primary" value="新建" onclick="doAdd()"/>
    </div>
    <!-- 内容信息 -->
        ...
        <div class="z-page-search-form" id="MainArea">
            <ec:table items="recordList" var="record" retrieveRowsCallback="limit"
                ...
                <ec:row recordKey="${record.noticeId}">
                    ...
                    <ec:column width="15%" property="noticeStartDate" title="开始日期" cell="date" parse="yyyy-MM-dd"
                               ellipsis="true"/>
                    <ec:column width="10%" property="noticeEndDate" title="结束日期" cell="date" parse="yyyy-MM-dd"
                               ellipsis="true"/>
                    <ec:column width="8%" property="createName" title="发布人" ellipsis="true"/>
                    <ec:column width="10%" property="createDate" title="发布日期" cell="date" parse="yyyy-MM-dd"
                               ellipsis="true"/>
                    <ec:column width="10%" property="noticeRangeName" title="通知范围" style="text-align:center;"
                               ellipsis="true"/>
