...
<body>
<form method="post" action="${pageContext.request.contextPath}/apparatusOnlineAction.do?method=doQuery" id="apparatusOnlineForm" name="apparatusOnlineForm">
	<div class="panel panel-default searchTool fl">
		<div class="panel-body">
			<table>
				...
				<tr>
					<td><span class="w110 name">在线状况</span></td>
					<td>
		...
		<ec:table items="recordList" var="record" retrieveRowsCallback="limit"
			...
			<ec:row recordKey="${record.apparatusId}">
				...
				<ec:column width="10%" property="_2" title="操作" viewsAllowed="html">
					<a href="javascript:return void(0)" onclick="getOrdApplyList('${record.apparatusId}')">查看预约信息</a>
				</ec:column>
			</ec:row>
		</ec:table>
	</div>
