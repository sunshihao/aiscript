...
<body>
<form method="post" action="/apparatusViewAction.do?method=doQuery" id="apparatusViewForm" name="apparatusViewForm">
	<input class="w140" type="hidden" id="endPurchaseDateHidden" name="endPurchaseDateHidden" value="${endPurchaseDate }"/>
	<div class="panel panel-default searchTool fl">
		<div class="panel-body">
			<table>
				...
				<tr id="hiddenTr1">
					<td>
						<span  class="w110 name">购置日期起</span>
					</td>
					<td>
						<input class="w140 Wdate" type="text" id="startPurchaseDate" name="startPurchaseDate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',errDealMode:0});" value="1900-01-01"/>
					</td>
					<td>
						<span  class="w110 name">购置日期截止</span>
					</td>
					<td >
						<input class="w140 Wdate" type="text" id="endPurchaseDate" name="endPurchaseDate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',errDealMode:0});" value="${endPurchaseDate}"/>
					</td>
				...
				<%-- <tr id="hiddenTr2">
					...
					<td><span class="w110 name">数据来源</span></td>
					<td>
	...
	<div class="panel-body padding-0" id="MainArea">
		<ec:table items="recordList" var="record" retrieveRowsCallback="limit" useAjax="true"
			...
			<ec:row recordKey="${record.apparatusId}">
				...
				<ec:column style="text-align:center" width="6%" property="bookType" title="预约类型" mappingItem="bookTypeMap"/>
				<ec:column style="text-align:center" width="6%" property="bookForm" title="预约方式" mappingItem="bookFormMap"/>
