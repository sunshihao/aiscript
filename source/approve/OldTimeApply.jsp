...
<link rel="stylesheet" href="<%=webPath%>/sams/common/css/style.css" type="text/css">
 ...
 <script type="text/javascript" src="<%=webPath%>/sams/ord/approve/OldTimeApply.js?v=<%=Math.random()%>"></script>
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="ilead-table-box fl" id="itemInfo">
				<h3>检测项目及标准 </h3>
				<div>
					<ec:table items="resultItemList" var="resultPara" retrieverowscallback="limit" tableid="ectable" action="${pageContext.request.contextPath}/standardAction.do?method=doEdit" listwidth="100%" resizecolwidth="true" classic="true" toolbarcontent="extend" rowsdisplayed="50">
