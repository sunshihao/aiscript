...
<div class="panel panel-default fl">
	<div class="panel-body padding-0" id="MainArea">
		<ec:table items="recordList" var="record" retrieverowscallback="limit" action="${pageContext.request.contextPath}/ordApproveAction.do?method=getApplyList" title="" xlsfilename="委托单信息列表.xls" csvfilename="委托单信息列表.csv" listwidth="100%" resizecolwidth="true" queryform="ordApproveForm" pagesizelist="10,20,50" rowsdisplayed="10" classic="true">
			<ec:row recordkey="${record.ordId}">
				<ec:column style="text-align:center;" width="25px" cell="checkbox" headercell="checkbox" alias="checkboxID" property="ordId" value="${record.ordId}!${record.ordReceiveUnit}!${record.ordNo}!${record.ordApplyEmail}!${record.ordState}" viewsallowed="html">
			...
			</ec:column></ec:column></ec:column></ec:column></ec:column></ec:column></ec:column></ec:row>
		</ec:table>
	</div>
</div>
